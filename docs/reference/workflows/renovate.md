...
| ------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `eslint`      | `< 10.0.0`  | [ESLint ↗](https://eslint.org) majors are held until [angular-eslint ↗](https://github.com/angular-eslint/angular-eslint) supports them across the framework's package family. |
